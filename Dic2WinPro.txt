...
// * Lucky.Win - fair games that pay Ether. Version 5.
//
// * Ethereum smart contract, deployed at 0x6ad7ff9944e5aa09d3fc037b6d9ebeb0dee7d862.
//
// * Uses hybrid commit-reveal + block hash random number generation that is immune
//   to tampering by players, house and miners. Apart from being fully transparent,
//   this also allows arbitrarily high bets.
//
// * Refer to https://lucky.win/whitepaper.pdf for detailed description and proofs.
//
// * New feature is following:
// * 1. MAX_AMOUNT can be modified by setMaxAmount method, MIN_BET can be get
// * 2. event Send() can emit internal transaction and will be treat by explorer
//
...
contract LuckyWin {
    ...
    address constant SECRET_SIGNER_ADDRESS = 0x2c1B2007754730e36D207684f1D4CAEC6d799000;
    address constant CROUPIER_ADDRESS = 0x999ee1199dd41B02066aeFff8Ebf3d85AC5D4119;
    ...
    //There is maximum bets to be adjusted if need.
    ...
    //Events that are issued to make internal transaction
    event Send(address indexed beneficiary, uint amount);

    // Constructor. Deliberately does not take any parameters.
    constructor () public {
        owner = msg.sender;
        secretSigner = SECRET_SIGNER_ADDRESS;
        croupier = CROUPIER_ADDRESS;
        minAmount = MIN_BET;
    ...
    function setMaxProfit(uint _maxProfit) public onlyOwner {
        require (_maxProfit < maxAmount, "maxProfit should be a sane number.");
        maxProfit = _maxProfit;
    }

    // Change max bet amount. Setting this to zero effectively disables betting.
    function setMaxAmount(uint _maxAmount) public onlyOwner {
        require (_maxAmount < MAX_AMOUNT, "maxAmount should be a sane number.");
    ...
    function placeBet(uint betMask, uint modulo, uint commitLastBlock, uint commit, bytes32 r, bytes32 s) external payable {
        ...
        require (amount >= minAmount && amount <= maxAmount, "Amount should be within range.");
